...
from Formularios import agregarCaracteristicas
...
class Vagregarcaracteristicas(QtGui.QDialog):
    def __init__(self, parent = None):
        "Constructor de la ventana de gestion de fichas"
        QtGui.QWidget.__init__(self,parent)
        self.ui = agregarCaracteristicas.Ui_Dialog()
        ...
        QtCore.QObject.connect(self.ui.pbTerminarCaracteristicas, QtCore.SIGNAL("clicked()"),
                               self.pbTerminarCaracteristicas_click)
    ...
    def pbTerminarCaracteristicas_click(self):
        "Finalizado"
